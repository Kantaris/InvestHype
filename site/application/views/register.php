        ...
        <div class="content">
            <div class="container">
                <div class="row register-box">
                    <form action="<?php echo $basePath;?>user/signup.html" method="post" role="form">
                        ...
                        <div class="row margin-bottom-10 form-group">
                            <input type="email" placeholder="Email Address" id="email" name="email" class="form-control" required maxlength="100" value="">
                        </div>
                        <div class="row margin-bottom-10 form-group">
                            <input type="text" placeholder="Username" id="username" name="username" class="form-control" required maxlength="200" value="">
                        </div>
                        <div class="row margin-bottom-10 form-group">
                        ...
                        <div class="row margin-bottom-10" style="text-align: center;">
                            <button type="submit" style="width: 75%;" class="btn btn-success">Create Account</button>
                        </div>
                        
                        <div class="row form-group" style="padding: 10px 5px 10px 5px; line-height: 35px; text-align: center;">
                            <a href="<?php echo $basePath;?>user/login.html" class="menu-button">Login</a>
                            <br>
